    ...
    public static void commanderUnePreparation(HashMap<Object, Object> checkBoxSpinnerMap) {
        ...
        searchField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void updateList() {
                ...
                java.util.List<Medicament> filteredMedicaments = UiGui.pharmacie.filterMedicaments(search);
        ...
        buttonCommander.addActionListener(e -> {
            ...
            if (!LectureOrdonnanceCsv.ordonnanceDisponible(referenceOrdonnance)) {
                ...
                java.util.List<String> medicamentsPrescrits = LectureMedicamentsCsv.getMedicamentsPrescrits(referenceOrdonnance);
                ...
                if (!Medicament.medicamentsCorrespondants(medicamentsPrescrits)) {
                    ...
                    if (stockInsuffisant[0]) {
                        ...
                        java.util.List<Medicament> selectedMedicaments = new ArrayList<>();
                        java.util.List<Integer> selectedQuantities = new ArrayList<>();
                        ...
                        validateButton.addActionListener(_ -> {
                            ...
                            if (stockInsuffisant[0]) {
                                ...
                                // Ecrire les informations de la préparation dans le fichier CSV (à implémenter)
